...
(period, climate_index, threshold, idx_basin, months, mpi_bounds,
 months_for_coef_MPI, months_for_coef_PRESS, generation_phase) = import_data.input_data('input.dat')
...
df1 = data.to_dataframe()[['lat', 'lon', 'sid', 'season', 'number', 'basin', 'subbasin', 'name', 'iso_time', 'wmo_wind', 'wmo_pres','track_type', 'main_track_sid', 'dist2land', 'landfall','usa_sshs','usa_rmw']]
...
try:
    ...
    pass
preprocessing.TC_variables(nyear, months, oni_table=oni_table, vws_fields=vws_fields, rh_fields=rh_fields, latitudes=latitudes, longitudes=longitudes)
